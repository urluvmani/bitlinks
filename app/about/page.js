  ...
  return (
    <div className="min-h-screen px-6 py-10 bg-gray-900 text-white">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg mb-4">
          Whether you're sharing links on social media, tracking click performance, or just want a cleaner way to share URLs — BitLinks helps you do it quickly and securely.
        </p>
        <p className="text-lg mb-4">
